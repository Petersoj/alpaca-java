...
public class AlpacaProperties {
    ...
    public static final String KEY_ID = PropertyUtil.getProperty(
    ...
    public static final String SECRET_KEY = PropertyUtil.getProperty(
            ALPACA_PROPERTIES_FILE, ALPACA_DEFAULT_PROPERTIES_FILE,
            SECRET_KEY_KEY);
    ...
    public static final EndpointAPIType ENDPOINT_API_TYPE = EndpointAPIType.fromValue(PropertyUtil.getProperty(
            ALPACA_PROPERTIES_FILE, ALPACA_DEFAULT_PROPERTIES_FILE,
    ...
    public static final DataAPIType DATA_API_TYPE = DataAPIType.fromValue(PropertyUtil.getProperty(
            ALPACA_PROPERTIES_FILE, ALPACA_DEFAULT_PROPERTIES_FILE,
            DATA_API_TYPE_KEY));

    private static final String USER_AGENT_KEY = "user_agent";
    /** The value of {@link #USER_AGENT_KEY} in {@link #ALPACA_PROPERTIES_FILE}. */
    public static final String USER_AGENT = PropertyUtil.getProperty(
            ALPACA_PROPERTIES_FILE, ALPACA_DEFAULT_PROPERTIES_FILE,
            USER_AGENT_KEY);
}
