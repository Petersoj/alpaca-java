...
/**
 * The class AlpacaOAuthAPI. Note that most of these methods are blocking methods and this class in NOT thread-safe.
 */
public class AlpacaOAuthAPI {

    /** The logger. */
    private static final Logger LOGGER = LogManager.getLogger(AlpacaOAuthAPI.class);
     ...
     */
    public AlpacaOAuthAPI() {
        this(AlpacaProperties.API_VERSION_VALUE, AlpacaProperties.AUTH_TOKEN_VALUE, AlpacaProperties.BASE_API_URL_VALUE,
     ...
     */
    public AlpacaOAuthAPI(String apiVersion) {
        this(apiVersion, AlpacaProperties.AUTH_TOKEN_VALUE,
     ...
     */
    public AlpacaOAuthAPI(String apiVersion, String token) {
        this(apiVersion, token, AlpacaProperties.BASE_API_URL_VALUE,
                AlpacaProperties.BASE_DATA_URL_VALUE);
    }
     ...
     */
    public AlpacaOAuthAPI(String apiVersion, String token, String baseAPIURL) {
        this(apiVersion, token, baseAPIURL, AlpacaProperties.BASE_DATA_URL_VALUE);
    }
     ...
     */
    public AlpacaOAuthAPI(String apiVersion, String token, String baseAPIURL, String baseDataUrl) {
        this.apiVersion = apiVersion;
        this.auth_token = token;
        this.baseAPIURL = baseAPIURL;
        this.baseDataUrl = baseDataUrl;

        alpacaRequest = new AlpacaRequest(token);
        alpacaWebSocketClient = new AlpacaWebsocketClient(token, baseAPIURL);
        marketDataWebSocketClient = new MarketDataWebsocketClient(token, baseDataUrl);
